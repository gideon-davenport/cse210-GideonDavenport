...
public class Car
{
    ...
    public void Run()
    {
        ...
        while (IsRunning)
        {
            ...
            else if (input == "5") button.IsArmed = true;
            else if (input == "6") button.IsArmed = false;
            else if (input == "7") IsRunning = false;
    ...
    public void PrintMenu()
    {
        ...
        Console.WriteLine("5. Activate Panic");
        Console.WriteLine("6. Deactivate Panic");
